...
const COMMANDS: Command[] = [
  ...
  },
  {
    ...
    usage: [
      'ms upload ~/Pictures/beach --tag beach --tag 2019',
  ...
  },
  {
    ...
    usage: ['ms ls', 'ms ls --tag beach --kind photo', 'ms ls --json'],
    flags: lsFlags,
    run: ls,
  },
  {
    ...
    usage: ['ms tag a1b2c3 d4e5f6 --add beach', 'ms tag --from beach --add 2019 --remove todo'],
    flags: tagFlags,
    run: tag,
  },
  {
    ...
    usage: [
      'ms memory create "Beach" --tag beach --expires 30d',
      'ms memory ls',
      'ms memory show beach-2019',
      'ms memory add beach-2019 --tag with-family',
      'ms memory set beach-2019 --expires 90d',
      'ms memory rotate beach-2019',
      'ms memory rm beach-2019',
    ],
    flags: memoryFlags,
    run: memory,
  ...
  },
  {
    ...
    usage: [
      'ms download beach-2019 ./out',
      'ms download --tag beach ./out',
      'ms download --tag beach --variant view ./proxies',
    ],
    flags: downloadFlags,
    run: download,
    details: [
